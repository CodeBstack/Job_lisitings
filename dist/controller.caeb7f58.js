...
})({"a0d14784723a87c24306d6a27f6e2ca6":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "caeb7f58655b10cef44d159e3580b82d";
...
new _view.default(data); // data.forEach((data) => {
//   console.log(data);
//   //   view.render(data);
// });
...
// };
},{"./view.js":"ca097ab72fc2d46718e38115b0b96a37"}],"ca097ab72fc2d46718e38115b0b96a37":[function(require,module,exports) {
"use strict";
      ...
      <div class="item item-1">
            ...
            <div class="item-content">
              <div class="company">
                ...
                <p><span class="featured">${this.data.featured ? "FEATURED" : ""}</span></p>
              </div>
            ...
            <div class="right-items">
              ...
              <div class="languages">
              <div><h3 class="language">${this.data.languages.length >= 1 ? this.data.languages[0] : ""}</h3></div>
              <div><h3 class="language">${this.data.languages.length >= 2 ? this.data.languages[1] : ""}</h3></div>
              <div><h3 class="language">${this.data.languages.length === 3 ? this.data.languages[2] : ""}</h3></div>
              </div>
              <div class="tools">
              <div><h3 class="tool">${this.data.tools.length >= 1 ? this.data.tools[0] : ""}</h3></div>
              <div><h3 class="tool">${this.data.tools.length >= 2 ? this.data.tools[1] : ""}</h3></div>
              </div>
            </div>
          </div>
      `;
...
exports.default = App;
},{}]},{},["a0d14784723a87c24306d6a27f6e2ca6","175e469a7ea7db1c8c0744d04372621f"], null)

//# sourceMappingURL=controller.caeb7f58.js.map
